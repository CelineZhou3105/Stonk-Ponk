...
class ForexTestCase(TestCase):
    ...
    def test_100_aud_usd(self):
        forex_api_list = [{"name":"alphavantage", "priority": 2}, {"name":"yahoo_finance", "priority": 1}]
        print(self.f_api.set_forex_api_order(forex_api_list))
        print(self.f_api.calc_forex_rate(100, self.from_currency, self.to_currency))


class StockTestCase(TestCase):
    '''
    def test_stock_functions(self):
