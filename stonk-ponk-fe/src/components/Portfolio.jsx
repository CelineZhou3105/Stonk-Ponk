		...
		<div>
			...
			<PageContainer>
				...
				{chartData !== "Loading" && (
					<Container align_items="center" justify_content="space-evenly">
						...
						<PortfolioValueContainer>
							...
							<Tooltip
								title="This is the current value of the portfolio after all US stocks have been converted to AUD"
								placement="bottom"
							>
							...
							<Tooltip
								title={`Contributions - How much you have invested into your portfolio.`}
								placement="right"
							>
						...
						<PortfolioHealthContainer>
							...
							{health !== "Loading" ? (
								<>
									<Tooltip
										title="Measures the diversification of your portfolio in comparison to the S&P500 (market)"
										placement="right"
									>
									...
									/>
									<Tooltip
										title={`Measures the profitability of your portfolio in comparison to the S&P500 (market)`}
										placement="right"
									>
									...
									/>
									<Tooltip
										title={`Measures how much your portfolio's value shifts in proportion to changes in the S&P500 (market)`}
										placement="right"
									>
								...
								return (
									<>
										...
										<SubText>
											{stock.ticker}
											<ColorText color="#00AD30">
												({stock.profit_margin > 0 ? "+" : ""}
												{stock.profit_margin.toFixed(2)}%)
											</ColorText>
										</SubText>
									</>
								);
							...
							<Container flex_direction="column">
								...
								{suggestions.length > 2 && (
									<>
										...
										<PortfolioSuggestionSubText>
											{suggestions.length > 2 && suggestions[2]}
										</PortfolioSuggestionSubText>
									</>
								)}
							</Container>
				...
				{portfolioStocks !== "Loading" && (
					<>
						<LeftButtonContainer>
							<CustomButton onClick={() => setBuyNow(true)}>
								<ShoppingCartIcon />
								What if I buy now?
							</CustomButton>
							<CustomButton onClick={() => setSellNow(true)}>
								<AttachMoneyIcon />
								What if I sell now?
							</CustomButton>
						</LeftButtonContainer>
				...
				{buyNow && (
					<ModalContainer>
						<ModalContent>
							...
							{portfolioStocks.length === 0 ? noStocksSuggestion : stocksSuggestion}
						</ModalContent>
					</ModalContainer>
				)}
				{sellNow && (
