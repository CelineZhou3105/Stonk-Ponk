...
import { FlexRowLeftDiv, FlexColumnLeftDiv, PageContainer, LineDivider, SettingRowDiv, SettingEditRowDiv, SettingFieldDiv, ModalContainer, ModalContent, SettingModalDiv, FlexColumnCenterDiv, ProfilePictureContainer } from '../css/Div';
            ...
            <PageContainer>
                ...
                <FlexRowLeftDiv>
                    <ProfilePictureContainer>
                        ...
                        <CustomButton backgroundColor="#9e22ff" hoverColor="#b55cfa" margin="10px" aria-label="open up form to change profile picture" onClick={() => setProfileModalDisabled(false)}>Change Profile Picture</CustomButton>
                                ...
                                <ModalContent style={{ width: "80%", padding: "5px" }}>
                                    ...
                                    <FlexColumnCenterDiv>
                                        <ImageUploader
                                            ...
                                            singleImage={true}
                                        />
                                        <CustomButton backgroundColor="#9e22ff" hoverColor="#b55cfa" aria-label="save uploaded profile picture" onClick={changeProfilePic}>Save Profile Picture</CustomButton>
                                    </FlexColumnCenterDiv>
                                </ModalContent>
                            </ModalContainer>
                        }
                    ...
                    <FlexColumnLeftDiv style={{ width: "80%" }}>
                        ...
                        <SettingRowDiv>
                            <EditButton aria-label="Edit password Button" onClick={() => setDetailModalDisabled(false)}>Edit Password</EditButton>
                        </SettingRowDiv>
                        {!detailModalDisabled &&
                            <ModalContainer>
                                <ModalContent>
